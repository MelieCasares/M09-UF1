...
public class XifradorRotX implements Xifrador {
    public final static char[] LETTERSMIN = "aáàäbcçdeéèëfghiíìïjklmnñoóòöpqrstuúùüvwxyz".toCharArray();
    public final static char[] LETTERSMAYUS = "AÁÀÄBCÇDEÉÈËFGHIÍÌÏJKLMNÑOÓÒÖPQRSTUÚÙÜVWXYZ".toCharArray();
    ...
    public char encrypthLetter(char letter, int desplaçament, boolean decode) {
        if (decode == false) {
