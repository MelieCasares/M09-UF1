...
public class XifradorAES implements Xifrador {
    public final static String ALGORISME_XIFRAT = "AES";
    public final static  String ALGORISME_HASH = "SHA-256";
    public final static String FORMAT_AES = "AES/CBC/PKCS5Padding";

    private final static int MIDA_IV = 16;
    private static byte[] iv = new byte[MIDA_IV];
    private final static String CLAU = "CyPHER";
